...
const desktopApi: DesktopApi = {
  ...
  getTimelinePreviewFileInfo: (sourcePath: string) => ipcRenderer.invoke('preview:fileInfo', sourcePath),
  readTimelinePreviewRange: (sourcePath: string, offset: number, length: number) => ipcRenderer.invoke('preview:readRange', sourcePath, offset, length),
  getTimelinePreviewCacheState: (sourcePath: string) => ipcRenderer.invoke('preview:cacheState', sourcePath),
